...
class Meta:
    ...
    def create(self, validated_data):
        try:
            ...
            raise exceptions.ParseError('Já existe um usuario cadastrado com esse nome', code=status.HTTP_400_BAD_REQUEST)
...
class PerfilSimplificadoSerializer(serializers.ModelSerializer):
    pode_convidadr = serializers.SerializerMethodField()
